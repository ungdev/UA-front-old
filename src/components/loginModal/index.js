                    ...
                    <form onSubmit={submitForm} className="a-register-form">
                      ...
                      <div style={{ marginBottom: '10px' }}>
                        ...
                        <span style={{ fontSize: '10px' }}>
                          Je certifie avoir lu et accepté sans réserve les{' '}
                          <a href="/mentions-legales">conditions d'utilisation</a> du site
                        </span>
                      </div>
                      {this.state.loading && (
                        <div style={{ margin: '12px 0 0 0' }}>Envoi en cours...</div>
                      )}
                      <br />
                      <Button type="submit" raised>
                        Inscription
