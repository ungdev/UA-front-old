...
const Spotlights = () => (
  <div className="a-spotlights">
    ...
    <div style={{ marginTop: '26px', textAlign: 'justify' }}>
      <span>League of Legends (COMPLET)</span>,{' '}
      <span>Counter-Strike: Global Offensive (COMPLET)</span>, <span>Hearthstone</span>,{' '}
      <span>Super Smash Bros Ultimate</span> et <span>Fortnite (COMPLET)</span>. Les cinq jeux
