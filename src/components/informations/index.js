...
const Informations = () => (
  <div className="a-informations">
    ...
    <p>
      L'UTT Arena revient pour sa 16<sup>ème</sup> édition les <span>7, 8 et 9 décembre 2018</span>.
      Cette édition aura lieu – comme l'année dernière – dans le cadre du{' '}
      <span>Festival des Jeux</span> au Parc des Expositions de Troyes, le Cube. Au programme
      <span> 5 tournois</span> sur des incontournables de l'E-sport, du skill, des personnalités et
      des rencontres, de nombreuses animations, des <span>lots</span> et du <span>cashprize</span> à
      gagner, qui rendront cette édition plus intense et vibrante que jamais. Pas fan des jeux
      proposés ? Pas envie d’être dans un cadre compétitif ? L’UTT Arena propose un{' '}
      <span>tournoi libre</span>, composé des jeux que vous choisissez ! Alors récupère ta souris,
      ton casque et ton câble réseau, branche ton écran et{' '}
    ...
    <div className="a-informations__table">
      ...
      <div className="a-informations__table__row">
        ...
        <div className="a-informations__table__row__cell">
          5 (les tournois commencent le samedi à 10h précises)
        </div>
      </div>
    </div>
