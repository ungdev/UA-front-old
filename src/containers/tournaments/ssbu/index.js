...
const SSBU = () => {
  return (<React.Fragment>
    ...
    <div className="a-tournament-content">
      ...
      <p><strong>Interruption du match :</strong> si un match est involontairement interrompu, les joueurs sont invitées à recommencer la partie.</p>
