...
const SSBU = () => {
  return (<React.Fragment>
    <Meta title="Tournoi SSBU" description="Vous retrouverez sur cette page toutes les informations relatives au tournoi Super Smash Bros Ultimate de l'UTT Arena. L'inscription à l'UTT Arena est fixée à 15€ par joueur. La LAN se déroulera du Vendredi 6 Décembre 18h au Dimanche 8 Décembre à 18h"/>
    <ScrollToTopOnMount/>
