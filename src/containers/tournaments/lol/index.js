...
const LOL = () => {
  return (<React.Fragment>
    ...
    <div className="a-tournament-content">
      <p>Vous retrouverez sur cette page toutes les informations relatives aux tournois League of Legends, pro et amateur. <strong>Attention, ces informations peuvent évoluer,
      tenez-vous informés via nos réseaux (Facebook/Twitter)</strong>.</p>
      {/*Rajouter un lien vers les réseaux ?*/}
