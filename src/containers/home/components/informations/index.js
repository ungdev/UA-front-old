...
const Informations = () => (
  <div className="a-informations">
    ...
    <p>
      L'UTT Arena revient pour sa 16ème édition les 8, 9 et 10 décembre 2017. Cette édition aura
      lieu comme l'année dernière dans le cadre du Festival des Jeux au Cube de Troyes. Au programme
      4 tournois sur des incontournables de l'E-sports, du skill, des personnalités et des
      rencontres, de nombreuses animations et lots à gagner, qui rendront cette édition plus intense
      et vibrante que jamais. Pas fan des jeux proposés ? Pas envie d’être dans un cadre compétitif
      ? L’UTT Arena propose plein d’animations pour leurs joueurs hors-tournoi ! Alors récupère ta
      souris, ton casque et ton câble réseau, branche ton écran et vient imposer la domination de
      ton équipe dans le Cube.
    </p>
    ...
    <div className="a-informations__table">
      ...
      <div className="a-informations__table__row">
        ...
        <div className="a-informations__table__row__cell">02/12 2018 - 18h</div>
      </div>
      <div className="a-informations__table__row">
        <div className="a-informations__table__row__cell">Fermeture</div>
        <div className="a-informations__table__row__cell">04/12/2018 - 18h</div>
      </div>
      <div className="a-informations__table__row">
