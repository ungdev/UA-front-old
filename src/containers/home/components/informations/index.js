...
const Informations = () => (
  <div className="a-informations">
    ...
    <p>
      L'UTT Arena revient pour sa <span>16ème édition</span> les <span>7, 8 et 9 décembre 2018</span>. Cette édition aura
      lieu comme l'année dernière dans le cadre du <span>Festival des Jeux</span> au <span>Centre d'exposition de Troyes, le Cube</span>. Au programme
      ...
      ? L’UTT Arena propose un <span>tounoi libre</span>, composé des jeux que <span>vous choisissez</span> ! Alors récupère ta
