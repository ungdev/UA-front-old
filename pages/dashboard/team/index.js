      ...
      <React.Fragment>
        ...
        <div className="a-teammanagement a-dashboard-page">
          ...
          <div className="a-teammanagement__badge">
            <StatusBadge theme={this.props.teamStatus.theme}>
              {this.props.teamStatus.status}
            </StatusBadge>
          </div>
          {!this.props.user.team.isInSpotlight &&
            this.props.teamStatus.complete === 1 &&
            this.props.spotlightFull && (
              <p className="a-teammanagement__warning">
                ...
                D'autres équipes se sont complétées plus rapidement. À moins qu'une équipe se
                désiste, vous ne pouvez plus participer au tournoi. Vous êtes donc concidéré comme
                membre du tournoi libre. Vous pouvez aussi recréer une autre équipe dans un autre
                spotlight s'il reste des places dans ceux-ci.
              </p>
            )}
          {this.props.user.team.isInSpotlight && (
            <p className="a-teammanagement__warning">
              Vous n'avez plus rien à faire à part venir avec votre matériel le 7 décembre (ou le 8
              si vous ne pouvez pas avant). <br />
              Restez informé via{' '}
          ...
          {this.props.teamStatus.complete === 0 && this.props.spotlightFull && (
            <p className="a-teammanagement__warning">
              ...
              rejoint l'équipe
              <strong> et</strong> aient payé leur place. Vous serez alors mis sur liste d'attente,
              au cas où une équipe se désiste. Vous pouvez rejoindre un autre tournoi en créant une
              nouvelle équipe dans le tournoi choisi, en attendant, vous êtes considérés comme
              membre du tournoi libre.
            </p>
          )}
          {this.props.teamStatus.complete === 0 && !this.props.spotlightFull && (
            <p className="a-teammanagement__warning">
              ...
              &nbsp;
              <strong>Tous les membres de l'équipe</strong> doivent avoir rejoint{' '}
              <strong>et</strong> payé leur place pour valider l'inscription au spotlight (
              {spotlight.perTeam} personnes pour le tournoi {spotlight.name}
              ). <br />
              <br />
              Si vous validez votre inscription trop tard, vous serez mis sur liste d'attente. Une
              équipe en liste d'attente est concidérée comme participant au tournoi libre, sauf si
              une place pour elle se libère dans le tournoi spotlight. Alors dépêchez vous ;)
            </p>
          )}
