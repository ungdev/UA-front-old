...
class Cart extends React.Component {
  ...
  render() {
    if (this.props.prices !== null && this.canRender) {
        ...
        <DashboardLayout>
          ...
          <form className="a-dashboard-page a-dashboard-payment">
            ...
            <p>
              ...
              Vous êtes d'une école partenaire et le prix n'est pas réduit ? Vérifiez votre e-mail
              dans <Link href="/dashboard/user">vos infos</Link>.
              <br/>
              <br/>
            ...
            <ListItem price={playerPrice} active={!this.state.plusone} onClick={this.switchToPlayer}>
              <h3>Place joueur</h3>
              <span>
              Place joueur.euse (tournoi spotlight ou libre). Permet d'avoir une place assise
              attitrée (sauf Super Smash Bros Ultimate)
            </span>
            </ListItem>
            <ListItem
