  ...
  render() {
    ...
    return (
      <React.Fragment>
          ...
          <div className="a-scoup-modal">
            <form className="a-scoup-form">
              ...
              <div>
                ...
                >
                  <h3>Kaliento</h3>
                  <span>Louer un chauffeur de main électrique Kaliento</span>
                </ListItem>
                <ListItem
                ...
                >
                  <h3>Souris</h3>
                  <span>Louer une souris gaming</span>
                </ListItem>
              </div>
              <div>
                <ListItem
                ...
                >
                  <h3>Clavier</h3>
                  <span>Louer un clavier gaming</span>
                </ListItem>
                <ListItem
                ...
                >
                  <h3>Casque</h3>
                  <span>Louer un casque gaming</span>
                </ListItem>
              </div>
              <div>
                <ListItem
                ...
                >
                  <h3>Chaise</h3>
                  <span>Louer une chaise gaming</span>
                </ListItem>
                <ListItem
                ...
                >
                  <h3>Écran 24"</h3>
                  <span>Louer un écran 24" 144Hz</span>
                </ListItem>
              </div>
              <div>
                <ListItem
                ...
                >
                  <h3>Écran 27"</h3>
                  <span>Louer un écran 27" 144Hz</span>
                </ListItem>
                <ListItem
                ...
                >
                  <h3>PC portable</h3>
                  <span>Louer un PC Portable Gaming</span>
              ...
              <div>
                ...
                >
                  <h3>PC Gaming</h3>
                  <span>Louer une tour gaming</span>
                ...
                >
                  <h3>PC streaming</h3>
                  <span>Louer un pc de streamer</span>
        ...
        <StreamingPCModal isOpen={this.state.isStreamingModalOpen} onClose={this.closeMoreInfo} />
